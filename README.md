...
These directions will install the development version in a way that will not
...
location first and install the package there:
    ...
    > install_github("RItools", user = "markmfredrickson", branch = "randomization-distribution")
